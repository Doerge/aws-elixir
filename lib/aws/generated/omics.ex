...
defmodule AWS.Omics do
  ...
  *AWS HealthOmics User Guide*.
  ...
  def get_read_set(%Client{} = client, id, sequence_store_id, part_number, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [file: nil, part_number: nil
    # ])
    ...
    {file, options} = Keyword.pop(options, :file, nil)
  ...
  def get_reference(%Client{} = client, id, reference_store_id, part_number, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [file: nil, part_number: nil, range: nil
    # ])
  ...
  def get_run(%Client{} = client, id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [export: nil
    # ])

    headers = []
    query_params = []

    {export, options} = Keyword.pop(options, :export, nil)
  ...
  def get_workflow(%Client{} = client, id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [export: nil, type: nil, workflow_owner_id: nil
    # ])

    headers = []
    query_params = []

    {workflow_owner_id, options} = Keyword.pop(options, :workflow_owner_id, nil)
  ...
  def list_run_groups(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [max_results: nil, name: nil, starting_token: nil
    # ])

    headers = []
    query_params = []

    {starting_token, options} = Keyword.pop(options, :starting_token, nil)
  ...
  def list_run_tasks(%Client{} = client, id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [max_results: nil, starting_token: nil, status: nil
    # ])
  ...
  def list_runs(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [max_results: nil, name: nil, run_group_id: nil, starting_token: nil, status: nil
    # ])
    ...
    {run_group_id, options} = Keyword.pop(options, :run_group_id, nil)
  ...
  def list_workflows(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [max_results: nil, name: nil, starting_token: nil, type: nil
    # ])
