...
defmodule AWS.MediaConvert do
  ...
  * `:order` (`t:enum["ASCENDING|DESCENDING"]`) 
  ...
  def list_job_templates(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [category: nil, list_by: nil, max_results: nil, next_token: nil, order: nil
    # ])
    ...
    {list_by, options} = Keyword.pop(options, :list_by, nil)
  ...
  * `:status` (`t:enum["CANCELED|COMPLETE|ERROR|PROGRESSING|SUBMITTED"]`) 
  ...
  def list_jobs(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [max_results: nil, next_token: nil, order: nil, queue: nil, status: nil
    # ])
    ...
    {queue, options} = Keyword.pop(options, :queue, nil)
  ...
  * `:order` (`t:enum["ASCENDING|DESCENDING"]`) 
  ...
  def list_queues(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [list_by: nil, max_results: nil, next_token: nil, order: nil
    # ])
