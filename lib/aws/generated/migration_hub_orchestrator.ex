...
defmodule AWS.MigrationHubOrchestrator do
  ...
  * `:template_id` (`t:string`) The ID of the template.
  ...
  def get_template_step(%Client{} = client, id, step_group_id, template_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [step_group_id: nil, template_id: nil
    # ])

    headers = []
    query_params = []

    {template_id, options} = Keyword.pop(options, :template_id, nil)
    ...
    {step_group_id, options} = Keyword.pop(options, :step_group_id, nil)
  ...
  * `:workflow_id` (`t:string`) The ID of the migration workflow.
  ...
  def get_workflow_step(%Client{} = client, id, step_group_id, workflow_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [step_group_id: nil, workflow_id: nil
    # ])

    headers = []
    query_params = []

    {workflow_id, options} = Keyword.pop(options, :workflow_id, nil)
  ...
  * `:workflow_id` (`t:string`) The ID of the migration workflow.
  ...
  def get_workflow_step_group(%Client{} = client, id, workflow_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [workflow_id: nil
    # ])
  ...
  * `:template_id` (`t:string`) The ID of the template.
  ...
  def list_template_steps(%Client{} = client, step_group_id, template_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [max_results: nil, next_token: nil, step_group_id: nil, template_id: nil
    # ])
  ...
  * `:workflow_id` (`t:string`) The ID of the migration workflow.
  ...
  def list_workflow_step_groups(%Client{} = client, workflow_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [max_results: nil, next_token: nil, workflow_id: nil
    # ])
  ...
  * `:template_id` (`t:string`) The ID of the template.
  ...
  def list_workflows(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [ads_application_configuration_name: nil, max_results: nil, name: nil, next_token: nil, status: nil, template_id: nil
    # ])
    ...
    {ads_application_configuration_name, options} =
      Keyword.pop(options, :ads_application_configuration_name, nil)
