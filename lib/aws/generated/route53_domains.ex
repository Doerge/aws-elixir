...
defmodule AWS.Route53Domains do
  ...
  """
  @spec check_domain_availability(
          AWS.Client.t(),
          check_domain_availability_request(),
          Keyword.t()
        ) ::
  ...
  """
  @spec check_domain_transferability(
          AWS.Client.t(),
          check_domain_transferability_request(),
          Keyword.t()
        ) ::
  ...
  """
  @spec delete_tags_for_domain(AWS.Client.t(), delete_tags_for_domain_request(), Keyword.t()) ::
  ...
  domain.
  """
  @spec disable_domain_auto_renew(
          AWS.Client.t(),
          disable_domain_auto_renew_request(),
          Keyword.t()
        ) ::
  ...
  """
  @spec enable_domain_auto_renew(AWS.Client.t(), enable_domain_auto_renew_request(), Keyword.t()) ::
  ...
  """
  @spec get_contact_reachability_status(
          AWS.Client.t(),
          get_contact_reachability_status_request(),
          Keyword.t()
        ) ::
  ...
  """
  @spec get_domain_detail(AWS.Client.t(), get_domain_detail_request(), Keyword.t()) ::
  ...
  """
  @spec get_domain_suggestions(AWS.Client.t(), get_domain_suggestions_request(), Keyword.t()) ::
  ...
  completed.
  """
  @spec get_operation_detail(AWS.Client.t(), get_operation_detail_request(), Keyword.t()) ::
  ...
  Domain restoration
  """
  @spec list_prices(AWS.Client.t(), list_prices_request(), Keyword.t()) ::
  ...
  immediately represent all issued operations.
  """
  @spec list_tags_for_domain(AWS.Client.t(), list_tags_for_domain_request(), Keyword.t()) ::
  ...
  """
  @spec push_domain(AWS.Client.t(), push_domain_request(), Keyword.t()) ::
          {:ok, nil, any()}
          | {:error, {:unexpected_response, any()}}
  ...
  """
  @spec register_domain(AWS.Client.t(), register_domain_request(), Keyword.t()) ::
  ...
  Guide*.
  """
  @spec renew_domain(AWS.Client.t(), renew_domain_request(), Keyword.t()) ::
  ...
  """
  @spec resend_operation_authorization(
          AWS.Client.t(),
          resend_operation_authorization_request(),
          Keyword.t()
        ) ::
  ...
  """
  @spec retrieve_domain_auth_code(
          AWS.Client.t(),
          retrieve_domain_auth_code_request(),
          Keyword.t()
        ) ::
  ...
  *Amazon Route 53 Developer Guide*.
  ...
  """
  @spec transfer_domain(AWS.Client.t(), transfer_domain_request(), Keyword.t()) ::
  ...
  *Amazon Route 53 Developer Guide*.
  ...
  successfully, the domain registrant will be notified by email.
  """
  @spec update_domain_contact(AWS.Client.t(), update_domain_contact_request(), Keyword.t()) ::
  ...
  """
  @spec update_domain_contact_privacy(
          AWS.Client.t(),
          update_domain_contact_privacy_request(),
          Keyword.t()
        ) ::
  ...
  """
  @spec update_domain_nameservers(
          AWS.Client.t(),
          update_domain_nameservers_request(),
          Keyword.t()
        ) ::
  ...
  immediately represent all issued operations.
  """
  @spec update_tags_for_domain(AWS.Client.t(), update_tags_for_domain_request(), Keyword.t()) ::
  ...
  """
  @spec view_billing(AWS.Client.t(), view_billing_request(), Keyword.t()) ::
