...
defmodule AWS.Codeartifact do
  ...
  **Asset**: An individual file stored in CodeArtifact associated with a package
  ...
  ## Optional parameters:
   ...
   • :domain_owner (t:String.t/0) (domain-owner)
   • :external_connection (t:String.t/0) (external-connection)
   • :repository (t:String.t/0) (repository)
  """
  ...
  ## Optional parameters:
   • :destination_repository (t:String.t/0) (destination-repository)
   • :domain (t:String.t/0) (domain)
   • :domain_owner (t:String.t/0) (domain-owner)
   • :format (t:String.t/0) (format)
   • :namespace (t:String.t/0) (namespace)
   • :package (t:String.t/0) (package)
   • :source_repository (t:String.t/0) (source-repository)
  """
  ...
  ## Optional parameters:
   • :domain (t:String.t/0) (domain)
   • :domain_owner (t:String.t/0) (domain-owner)
   • :policy_revision (t:String.t/0) (policy-revision)
  """
  ...
  ## Optional parameters:
   • :domain (t:String.t/0) (domain)
   • :domain_owner (t:String.t/0) (domain-owner)
   • :package_group (t:String.t/0) (package-group)
  """
  ...
  ## Optional parameters:
   ...
   • :namespace (t:String.t/0) (namespace)
   • :package (t:String.t/0) (package)
   • :package_version (t:String.t/0) (version)
   • :repository (t:String.t/0) (repository)
  """
  ...
  ## Optional parameters:
   • :domain (t:String.t/0) (domain)
   • :domain_owner (t:String.t/0) (domain-owner)
   • :duration_seconds (t:String.t/0) (duration)
  """
  ...
  ## Optional parameters:
   ...
   • :package (t:String.t/0) (package)
   • :package_version (t:String.t/0) (version)
   • :package_version_revision (t:String.t/0) (revision)
   • :repository (t:String.t/0) (repository)
  """
  ...
  ## Optional parameters:
   ...
   • :origin_restriction_type (t:String.t/0) (originRestrictionType)
   • :package_group (t:String.t/0) (package-group)
  """
  ...
  ## Optional parameters:
   ...
   • :namespace (t:String.t/0) (namespace)
   • :next_token (t:String.t/0) (next-token)
   • :origin_type (t:String.t/0) (originType)
   • :package (t:String.t/0) (package)
   • :repository (t:String.t/0) (repository)
  ...
  ## Optional parameters:
   ...
   • :namespace (t:String.t/0) (namespace)
   • :next_token (t:String.t/0) (next-token)
   • :package_prefix (t:String.t/0) (package-prefix)
   • :publish (t:String.t/0) (publish)
   • :repository (t:String.t/0) (repository)
   • :upstream (t:String.t/0) (upstream)
  """
  ...
  ## Optional parameters:
   • :max_results (t:String.t/0) (max-results)
   • :next_token (t:String.t/0) (next-token)
   • :repository_prefix (t:String.t/0) (repository-prefix)
  """
  ...
  ## Optional parameters:
   • :administrator_account (t:String.t/0) (administrator-account)
   • :domain (t:String.t/0) (domain)
   • :domain_owner (t:String.t/0) (domain-owner)
   • :max_results (t:String.t/0) (max-results)
   • :next_token (t:String.t/0) (next-token)
  ...
  ## Optional parameters:
   ...
   • :package_version (t:String.t/0) (version)
   • :repository (t:String.t/0) (repository)
   • :unfinished (t:String.t/0) (unfinished)
   • :asset_s_h_a256 (t:String.t/0) (x-amz-content-sha256)
  """
