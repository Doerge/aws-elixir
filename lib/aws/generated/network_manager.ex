...
defmodule AWS.NetworkManager do
  ...
  def describe_global_networks(%Client{} = client, options \\ []) do
    ...
    # options = Keyword.validate!(options, [global_network_ids: nil, max_results: nil, next_token: nil
    # ])
    ...
    {global_network_ids, options} = Keyword.pop(options, :global_network_ids, nil)
  ...
  def get_connect_peer_associations(%Client{} = client, global_network_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [connect_peer_ids: nil, max_results: nil, next_token: nil
    # ])
    ...
    {connect_peer_ids, options} = Keyword.pop(options, :connect_peer_ids, nil)
  ...
  def get_connections(%Client{} = client, global_network_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [connection_ids: nil, device_id: nil, max_results: nil, next_token: nil
    # ])
    ...
    {connection_ids, options} = Keyword.pop(options, :connection_ids, nil)
  ...
  def get_core_network_policy(%Client{} = client, core_network_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [alias: nil, policy_version_id: nil
    # ])

    headers = []
    query_params = []

    {policy_version_id, options} = Keyword.pop(options, :policy_version_id, nil)
  ...
  def get_customer_gateway_associations(%Client{} = client, global_network_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [customer_gateway_arns: nil, max_results: nil, next_token: nil
    # ])
    ...
    {customer_gateway_arns, options} = Keyword.pop(options, :customer_gateway_arns, nil)
  ...
  def get_devices(%Client{} = client, global_network_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [device_ids: nil, max_results: nil, next_token: nil, site_id: nil
    # ])

    headers = []
    query_params = []

    {site_id, options} = Keyword.pop(options, :site_id, nil)
    ...
    {device_ids, options} = Keyword.pop(options, :device_ids, nil)
  ...
  def get_link_associations(%Client{} = client, global_network_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [device_id: nil, link_id: nil, max_results: nil, next_token: nil
    # ])
    ...
    {link_id, options} = Keyword.pop(options, :link_id, nil)
  ...
  def get_links(%Client{} = client, global_network_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [link_ids: nil, max_results: nil, next_token: nil, provider: nil, site_id: nil, type: nil
    # ])
    ...
    {link_ids, options} = Keyword.pop(options, :link_ids, nil)
  ...
  def get_network_resource_relationships(%Client{} = client, global_network_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [account_id: nil, aws_region: nil, core_network_id: nil, max_results: nil, next_token: nil, registered_gateway_arn: nil, resource_arn: nil, resource_type: nil
    # ])
    ...
    {registered_gateway_arn, options} = Keyword.pop(options, :registered_gateway_arn, nil)
    ...
    {core_network_id, options} = Keyword.pop(options, :core_network_id, nil)
    ...
    {aws_region, options} = Keyword.pop(options, :aws_region, nil)
  ...
  def get_sites(%Client{} = client, global_network_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [max_results: nil, next_token: nil, site_ids: nil
    # ])

    headers = []
    query_params = []

    {site_ids, options} = Keyword.pop(options, :site_ids, nil)
  ...
  def get_transit_gateway_connect_peer_associations(
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [max_results: nil, next_token: nil, transit_gateway_connect_peer_arns: nil
    # ])

    headers = []
    query_params = []

    {transit_gateway_connect_peer_arns, options} =
      Keyword.pop(options, :transit_gateway_connect_peer_arns, nil)
  ...
  def get_transit_gateway_registrations(%Client{} = client, global_network_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [max_results: nil, next_token: nil, transit_gateway_arns: nil
    # ])

    headers = []
    query_params = []

    {transit_gateway_arns, options} = Keyword.pop(options, :transit_gateway_arns, nil)
  ...
  def list_attachments(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [attachment_type: nil, core_network_id: nil, edge_location: nil, max_results: nil, next_token: nil, state: nil
    # ])
    ...
    {edge_location, options} = Keyword.pop(options, :edge_location, nil)
    ...
    {attachment_type, options} = Keyword.pop(options, :attachment_type, nil)
  ...
  def list_connect_peers(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [connect_attachment_id: nil, core_network_id: nil, max_results: nil, next_token: nil
    # ])
    ...
    {connect_attachment_id, options} = Keyword.pop(options, :connect_attachment_id, nil)
  ...
  def list_peerings(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [core_network_id: nil, edge_location: nil, max_results: nil, next_token: nil, peering_type: nil, state: nil
    # ])
    ...
    {peering_type, options} = Keyword.pop(options, :peering_type, nil)
