...
defmodule AWS.QuickSight do
  ...
  ## Required positional parameters:
   • :aws_account_id (t:string String.t/0) (AwsAccountId)
   • :data_set_id (t:string String.t/0) (DataSetId)
   • :ingestion_id (t:string String.t/0) (IngestionId)
  ...
  *Amazon QuickSight User Guide*.
  ...
  ## Required positional parameters:
   ...
   • :member_type (t:enum String.t/0) (MemberType)
  ...
  ## Required positional parameters:
   • :aws_account_id (t:string String.t/0) (AwsAccountId)
   • :namespace (t:string String.t/0) (Namespace)
  ...
  ## Required positional parameters:
   ...
   • :member_name (t:string String.t/0) (MemberName)
   • :namespace (t:string String.t/0) (Namespace)
  ...
  ## Required positional parameters:
   • :alias_name (t:string String.t/0) (AliasName)
   • :aws_account_id (t:string String.t/0) (AwsAccountId)
   • :template_id (t:string String.t/0) (TemplateId)
  ...
  ## Required positional parameters:
   • :aws_account_id (t:string String.t/0) (AwsAccountId)
   • :theme_id (t:string String.t/0) (ThemeId)
  ...
  ## Required positional parameters:
   • :aws_account_id (t:string String.t/0) (AwsAccountId)
   • :topic_id (t:string String.t/0) (TopicId)
  ...
  ## Optional parameters:
   • :force_delete_without_recovery (t:String.t/0) (force-delete-without-recovery)
   • :recovery_window_in_days (t:String.t/0) (recovery-window-in-days)
  """
  ...
  ## Optional parameters:
   • :version_number (t:String.t/0) (version-number)
  """
  ...
  ## Required positional parameters:
   • :assignment_name (t:string String.t/0) (AssignmentName)
   • :aws_account_id (t:string String.t/0) (AwsAccountId)
   • :namespace (t:string String.t/0) (Namespace)
  ...
  ## Required positional parameters:
   • :aws_account_id (t:string String.t/0) (AwsAccountId)
   • :service (t:enum String.t/0) (Service)
  ...
  ## Required positional parameters:
   • :aws_account_id (t:string String.t/0) (AwsAccountId)
   • :data_set_id (t:string String.t/0) (DataSetId)
   • :schedule_id (t:string String.t/0) (ScheduleId)
  ...
  ## Required positional parameters:
   • :aws_account_id (t:string String.t/0) (AwsAccountId)
   • :namespace (t:string String.t/0) (Namespace)
   • :user_name (t:string String.t/0) (UserName)
  ...
  ## Required positional parameters:
   • :aws_account_id (t:string String.t/0) (AwsAccountId)
   • :vpc_connection_id (t:string String.t/0) (VPCConnectionId)
  ...
  ## Optional parameters:
   • :namespace (t:String.t/0) (namespace)
   • :resolved (t:String.t/0) (resolved)
  """
  ...
  def describe_account_customization(%Client{} = client, aws_account_id, options \\ []) do
    ...
    # options = Keyword.validate!(options, [namespace: nil, resolved: nil
    # ])

    headers = []
    query_params = []

    {resolved, options} = Keyword.pop(options, :resolved, nil)
  ...
  ## Required positional parameters:
   • :asset_bundle_export_job_id (t:string String.t/0) (AssetBundleExportJobId)
   • :aws_account_id (t:string String.t/0) (AwsAccountId)
  ...
  ## Required positional parameters:
   • :asset_bundle_import_job_id (t:string String.t/0) (AssetBundleImportJobId)
   • :aws_account_id (t:string String.t/0) (AwsAccountId)
  ...
  ## Optional parameters:
   • :alias_name (t:String.t/0) (alias-name)
   • :version_number (t:String.t/0) (version-number)
  """
  ...
  def describe_dashboard(%Client{} = client, aws_account_id, dashboard_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [alias_name: nil, version_number: nil
    # ])

    headers = []
    query_params = []

    {version_number, options} = Keyword.pop(options, :version_number, nil)
    ...
    {alias_name, options} = Keyword.pop(options, :alias_name, nil)
  ...
  ## Required positional parameters:
   • :aws_account_id (t:string String.t/0) (AwsAccountId)
   • :dashboard_id (t:string String.t/0) (DashboardId)
   • :snapshot_job_id (t:string String.t/0) (SnapshotJobId)
  ...
  def describe_folder_permissions(%Client{} = client, aws_account_id, folder_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [max_results: nil, namespace: nil, next_token: nil
    # ])
  ...
  ## Optional parameters:
   • :default_key_only (t:String.t/0) (default-key-only)
  """
  ...
  def describe_key_registration(%Client{} = client, aws_account_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [default_key_only: nil
    # ])

    headers = []
    query_params = []

    {default_key_only, options} = Keyword.pop(options, :default_key_only, nil)
  ...
  ## Required positional parameters:
   • :aws_account_id (t:string String.t/0) (AwsAccountId)
   • :refresh_id (t:string String.t/0) (RefreshId)
   • :topic_id (t:string String.t/0) (TopicId)
  ...
  ## Optional parameters:
   • :additional_dashboard_ids (t:String.t/0) (additional-dashboard-ids)
   • :identity_type (t:String.t/0) (creds-type)
   • :namespace (t:String.t/0) (namespace)
   • :reset_disabled (t:String.t/0) (reset-disabled)
   • :session_lifetime_in_minutes (t:String.t/0) (session-lifetime)
   • :state_persistence_enabled (t:String.t/0) (state-persistence-enabled)
   • :undo_redo_disabled (t:String.t/0) (undo-redo-disabled)
   • :user_arn (t:String.t/0) (user-arn)
  """
  ...
  def get_dashboard_embed_url(
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [additional_dashboard_ids: nil, identity_type: nil, namespace: nil, reset_disabled: nil, session_lifetime_in_minutes: nil, state_persistence_enabled: nil, undo_redo_disabled: nil, user_arn: nil
    # ])

    headers = []
    query_params = []

    {user_arn, options} = Keyword.pop(options, :user_arn, nil)
    ...
    {undo_redo_disabled, options} = Keyword.pop(options, :undo_redo_disabled, nil)
    ...
    {state_persistence_enabled, options} = Keyword.pop(options, :state_persistence_enabled, nil)
    ...
    {session_lifetime_in_minutes, options} =
      Keyword.pop(options, :session_lifetime_in_minutes, nil)
    ...
    {reset_disabled, options} = Keyword.pop(options, :reset_disabled, nil)
    ...
    {additional_dashboard_ids, options} = Keyword.pop(options, :additional_dashboard_ids, nil)
  ...
  ## Optional parameters:
   • :entry_point (t:String.t/0) (entry-point)
   • :session_lifetime_in_minutes (t:String.t/0) (session-lifetime)
   • :user_arn (t:String.t/0) (user-arn)
  """
  ...
  def get_session_embed_url(%Client{} = client, aws_account_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [entry_point: nil, session_lifetime_in_minutes: nil, user_arn: nil
    # ])
    ...
    {entry_point, options} = Keyword.pop(options, :entry_point, nil)
  ...
  ## Optional parameters:
   • :assignment_status (t:String.t/0) (assignment-status)
   • :max_results (t:String.t/0) (max-results)
   • :next_token (t:String.t/0) (next-token)
  """
  ...
  def list_iam_policy_assignments(%Client{} = client, aws_account_id, namespace, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [assignment_status: nil, max_results: nil, next_token: nil
    # ])
    ...
    {assignment_status, options} = Keyword.pop(options, :assignment_status, nil)
  ...
  ## Optional parameters:
   • :max_results (t:String.t/0) (max-result)
   • :next_token (t:String.t/0) (next-token)
  """
