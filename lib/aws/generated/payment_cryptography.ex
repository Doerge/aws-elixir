...
defmodule AWS.PaymentCryptography do
  ...
  in the *Amazon Web Services Payment Cryptography User Guide.* To use
  encryption keys for payment-related transaction processing and associated
  cryptographic operations, you use the [Amazon Web Services Payment
  Cryptography Data
  ...
  have multiple aliases. You can't create an alias without a key. The alias must
  be unique in the account and Amazon Web Services Region, but you can create
  another alias with the same name in a different Amazon Web Services Region. To
  change the key that's associated with the alias, call
  ...
  **Cross-account use**: This operation can't be used across different Amazon
  ...
  encryption and decryption. In addition to the key material used in
  ...
  **Cross-account use:** This operation can't be used across different Amazon
  ...
  example, you can't decrypt data that was encrypted by a deleted Amazon Web
  Services Payment Cryptography key, and the data may become unrecoverable.
  Because key deletion is destructive, Amazon Web Services Payment Cryptography
  has a safety mechanism to prevent accidental deletion of a key. When you call
  ...
  can export symmetric keys using either symmetric and asymmetric key exchange
  ...
  **Cross-account use:** This operation can't be used across different Amazon
  ...
  The export token and signing key certificate must be in place and operational
  before calling
  ...
  unencrypted, callers with `GetPublicKeyCertificate` permission can download
  ...
  in the *Amazon Web Services Payment Cryptography User Guide*. This is a
  paginated operation, which means that each response might contain only a
  subset of all the aliases. When the response contains only a subset of
  ...
  the keys. When the response contains only a subset of keys, it includes a
