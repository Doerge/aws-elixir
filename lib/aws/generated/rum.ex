...
defmodule AWS.RUM do
  ...
  * `:next_token` (`t:`) Use the token returned by the previous operation to request the next page of results.
  ...
  def batch_get_rum_metric_definitions(
    ...
    # options = Keyword.validate!(options, [destination: nil, destination_arn: nil, max_results: nil, next_token: nil
    # ])
    ...
    {destination_arn, options} = Keyword.pop(options, :destination_arn, nil)
    ...
    {destination, options} = Keyword.pop(options, :destination, nil)
