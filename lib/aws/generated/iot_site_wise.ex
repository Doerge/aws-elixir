...
defmodule AWS.IoTSiteWise do
  ...
  * `:exclude_properties` (`t:boolean`) 
  ...
  def describe_asset(%Client{} = client, asset_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [exclude_properties: nil
    # ])

    headers = []
    query_params = []

    {exclude_properties, options} = Keyword.pop(options, :exclude_properties, nil)
  ...
  * `:property_id` (`t:string`) The ID of the asset property. This can be either the actual ID in UUID format, or else <code>externalId:</code> followed by the external ID, if it has one.
  ...
  def describe_time_series(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [alias: nil, asset_id: nil, property_id: nil
    # ])

    headers = []
    query_params = []

    {property_id, options} = Keyword.pop(options, :property_id, nil)
    ...
    {asset_id, options} = Keyword.pop(options, :asset_id, nil)
  ...
  * `:time_ordering` (`t:enum["ASCENDING|DESCENDING"]`) The chronological sorting order of the requested information.
  ...
  def get_asset_property_aggregates(
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [aggregate_types: nil, asset_id: nil, end_date: nil, max_results: nil, next_token: nil, property_alias: nil, property_id: nil, qualities: nil, resolution: nil, start_date: nil, time_ordering: nil
    # ])

    headers = []
    query_params = []

    {time_ordering, options} = Keyword.pop(options, :time_ordering, nil)
    ...
    {qualities, options} = Keyword.pop(options, :qualities, nil)
    ...
    {property_alias, options} = Keyword.pop(options, :property_alias, nil)
    ...
    {aggregate_types, options} = Keyword.pop(options, :aggregate_types, nil)
  ...
  * `:property_id` (`t:string`) The ID of the asset property, in UUID format.
  ...
  def get_asset_property_value(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [asset_id: nil, property_alias: nil, property_id: nil
    # ])
  ...
  * `:time_ordering` (`t:enum["ASCENDING|DESCENDING"]`) The chronological sorting order of the requested information.
  ...
  def get_asset_property_value_history(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [asset_id: nil, end_date: nil, max_results: nil, next_token: nil, property_alias: nil, property_id: nil, qualities: nil, start_date: nil, time_ordering: nil
    # ])
  ...
  * `:type` (`t:string`) The interpolation type.
  ...
  def get_interpolated_asset_property_values(
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [asset_id: nil, end_time_in_seconds: nil, end_time_offset_in_nanos: nil, interval_in_seconds: nil, interval_window_in_seconds: nil, max_results: nil, next_token: nil, property_alias: nil, property_id: nil, quality: nil, start_time_in_seconds: nil, start_time_offset_in_nanos: nil, type: nil
    # ])
    ...
    {start_time_offset_in_nanos, options} = Keyword.pop(options, :start_time_offset_in_nanos, nil)
    ...
    {start_time_in_seconds, options} = Keyword.pop(options, :start_time_in_seconds, nil)
    ...
    {quality, options} = Keyword.pop(options, :quality, nil)
    ...
    {interval_window_in_seconds, options} = Keyword.pop(options, :interval_window_in_seconds, nil)
    ...
    {interval_in_seconds, options} = Keyword.pop(options, :interval_in_seconds, nil)
    ...
    {end_time_offset_in_nanos, options} = Keyword.pop(options, :end_time_offset_in_nanos, nil)
    ...
    {end_time_in_seconds, options} = Keyword.pop(options, :end_time_in_seconds, nil)
  ...
  * `:resource_type` (`t:enum["PORTAL|PROJECT"]`) The type of resource (portal or project). This parameter is required if you specify
  ...
  def list_access_policies(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [iam_arn: nil, identity_id: nil, identity_type: nil, max_results: nil, next_token: nil, resource_id: nil, resource_type: nil
    # ])
    ...
    {identity_type, options} = Keyword.pop(options, :identity_type, nil)
    ...
    {identity_id, options} = Keyword.pop(options, :identity_id, nil)
    ...
    {iam_arn, options} = Keyword.pop(options, :iam_arn, nil)
  ...
  * `:target_resource_type` (`t:enum["ASSET"]`) The type of resource.
  ...
  def list_actions(%Client{} = client, target_resource_id, target_resource_type, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [max_results: nil, next_token: nil, target_resource_id: nil, target_resource_type: nil
    # ])

    headers = []
    query_params = []

    {target_resource_type, options} = Keyword.pop(options, :target_resource_type, nil)
    ...
    {target_resource_id, options} = Keyword.pop(options, :target_resource_id, nil)
  ...
  * `:next_token` (`t:string`) The token to be used for the next set of paginated results.
  ...
  def list_asset_model_properties(%Client{} = client, asset_model_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [filter: nil, max_results: nil, next_token: nil
    # ])
    ...
    {filter, options} = Keyword.pop(options, :filter, nil)
  ...
  * `:next_token` (`t:string`) The token to be used for the next set of paginated results.
  ...
  def list_asset_models(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [asset_model_types: nil, max_results: nil, next_token: nil
    # ])
    ...
    {asset_model_types, options} = Keyword.pop(options, :asset_model_types, nil)
  ...
  * `:traversal_type` (`t:enum["PATH_TO_ROOT"]`) The type of traversal to use to identify asset relationships. Choose the following
  ...
  def list_asset_relationships(%Client{} = client, asset_id, traversal_type, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [max_results: nil, next_token: nil, traversal_type: nil
    # ])

    headers = []
    query_params = []

    {traversal_type, options} = Keyword.pop(options, :traversal_type, nil)
  ...
  * `:next_token` (`t:string`) The token to be used for the next set of paginated results.
  ...
  def list_assets(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [asset_model_id: nil, filter: nil, max_results: nil, next_token: nil
    # ])
    ...
    {asset_model_id, options} = Keyword.pop(options, :asset_model_id, nil)
  ...
  * `:traversal_direction` (`t:enum["CHILD|PARENT"]`) The direction to list associated assets. Choose one of the following options:
  ...
  def list_associated_assets(%Client{} = client, asset_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [hierarchy_id: nil, max_results: nil, next_token: nil, traversal_direction: nil
    # ])

    headers = []
    query_params = []

    {traversal_direction, options} = Keyword.pop(options, :traversal_direction, nil)
    ...
    {hierarchy_id, options} = Keyword.pop(options, :hierarchy_id, nil)
  ...
  * `:project_id` (`t:string`) The ID of the project.
  ...
  def list_dashboards(%Client{} = client, project_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [max_results: nil, next_token: nil, project_id: nil
    # ])
  ...
  * `:portal_id` (`t:string`) The ID of the portal.
  ...
  def list_projects(%Client{} = client, portal_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [max_results: nil, next_token: nil, portal_id: nil
    # ])

    headers = []
    query_params = []

    {portal_id, options} = Keyword.pop(options, :portal_id, nil)
  ...
  * `:time_series_type` (`t:enum["ASSOCIATED|DISASSOCIATED"]`) The type of the time series. The time series type can be one of the following
  ...
  def list_time_series(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [alias_prefix: nil, asset_id: nil, max_results: nil, next_token: nil, time_series_type: nil
    # ])

    headers = []
    query_params = []

    {time_series_type, options} = Keyword.pop(options, :time_series_type, nil)
    ...
    {alias_prefix, options} = Keyword.pop(options, :alias_prefix, nil)
