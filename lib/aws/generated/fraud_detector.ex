...
defmodule AWS.FraudDetector do
  ...
  see the [Amazon Fraud Detector User
  Guide](https://docs.aws.amazon.com/frauddetector/latest/ug/). We provide the
  Query API as well as AWS software development kits (SDK) for Amazon Fraud
  Detector in Java and Python programming languages.
  """
  ...
  maximum of 50 records per page. If you provide a `maxResults`, the value must
  ...
  maximum of 10 records per page. If you provide a `maxResults`, the value must
  ...
  predictions for events. An event type defines the structure for an event sent
  to Amazon Fraud Detector. This includes the variables sent as part of the
