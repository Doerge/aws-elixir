...
defmodule AWS.Pinpoint do
  ...
  ## Required positional parameters:
   • :application_id (t:string String.t/0) (ApplicationId)
   • :journey_id (t:string String.t/0) (JourneyId)
  ...
  ## Required positional parameters:
   • :recommender_id (t:string String.t/0) (RecommenderId)
  ...
  ## Required positional parameters:
   • :application_id (t:string String.t/0) (ApplicationId)
   • :segment_id (t:string String.t/0) (SegmentId)
  ...
  ## Required positional parameters:
   • :application_id (t:string String.t/0) (ApplicationId)
   • :kpi_name (t:string String.t/0) (KpiName)

  ## Optional parameters:
   • :end_time (t:String.t/0) (end-time)
   • :next_token (t:String.t/0) (next-token)
   • :page_size (t:String.t/0) (page-size)
   • :start_time (t:String.t/0) (start-time)
  """
  ...
  def get_application_date_range_kpi(%Client{} = client, application_id, kpi_name, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [end_time: nil, next_token: nil, page_size: nil, start_time: nil
    # ])
  ...
  def get_apps(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [page_size: nil, token: nil
    # ])

    headers = []
    query_params = []

    {token, options} = Keyword.pop(options, :token, nil)
  ...
  def get_email_template(%Client{} = client, template_name, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [version: nil
    # ])
  ...
  ## Required positional parameters:
   • :application_id (t:string String.t/0) (ApplicationId)
   • :journey_activity_id (t:string String.t/0) (JourneyActivityId)
   • :journey_id (t:string String.t/0) (JourneyId)
  ...
  ## Required positional parameters:
   • :template_name (t:string String.t/0) (TemplateName)
   • :template_type (t:string String.t/0) (TemplateType)
  ...
  ## Optional parameters:
   ...
   • :template_type (t:String.t/0) (template-type)
  """
  ...
  def list_templates(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [next_token: nil, page_size: nil, prefix: nil, template_type: nil
    # ])

    headers = []
    query_params = []

    {template_type, options} = Keyword.pop(options, :template_type, nil)
  ...
  ## Required positional parameters:
   • :application_id (t:string String.t/0) (ApplicationId)
   • :attribute_type (t:string String.t/0) (AttributeType)
  ...
  ## Optional parameters:
   • :create_new_version (t:String.t/0) (create-new-version)
   • :version (t:String.t/0) (version)
  """
