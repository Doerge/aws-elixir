...
defmodule AWS.PcaConnectorAd do
  ...
  ## Required positional parameters:
   ...
   • :directory_registration_arn (t:string String.t/0) (DirectoryRegistrationArn)
  ...
  ## Required positional parameters:
   • :group_security_identifier (t:string String.t/0) (GroupSecurityIdentifier)
   • :template_arn (t:string String.t/0) (TemplateArn)
  ...
  ## Optional parameters:
   • :connector_arn (t:String.t/0) (ConnectorArn)
   • :max_results (t:String.t/0) (MaxResults)
   • :next_token (t:String.t/0) (NextToken)
  """
  ...
  def list_templates(%Client{} = client, connector_arn, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [connector_arn: nil, max_results: nil, next_token: nil
    # ])
    ...
    {connector_arn, options} = Keyword.pop(options, :connector_arn, nil)
