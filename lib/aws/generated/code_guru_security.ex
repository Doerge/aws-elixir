...
defmodule AWS.CodeGuruSecurity do
  ...
  ## Required positional parameters:
  * `:scan_name` (`t:string`) The name of the scan you want to retrieve findings from.

  ## Optional parameters:
  * `:max_results` (`t:`) The maximum number of results to return in the response. Use this parameter when
  ...
  * `:status` (`t:enum["ALL|CLOSED|OPEN"]`) The status of the findings you want to get. Pass either <code>Open</code>,
  ...
  ## Optional parameters:
  * `:date` (`t:`) The date you want to retrieve summary metrics from, rounded to the nearest day. The date
  ...
  * `:scan_name` (`t:string`) The name of the scan you want to view details about.
  ...
  ## Optional parameters:
  * `:run_id` (`t:string`) UUID that identifies the individual scan run you want to view details about. You retrieve
      this when you call the <code>CreateScan</code> operation. Defaults to the latest scan run if missing.
  """
  ...
  ## Optional parameters:
  * `:end_date` (`t:`) The end date of the interval which you want to retrieve metrics from.
  * `:max_results` (`t:`) The maximum number of results to return in the response. Use this parameter when
      paginating results. If additional results exist beyond the number you specify, the <code>nextToken</code>
      element is returned in the response. Use <code>nextToken</code> in a subsequent request to retrieve
      additional results.
  * `:next_token` (`t:string`) A token to use for paginating results that are returned in the response. Set the
      ...
      page.
  * `:start_date` (`t:`) The start date of the interval which you want to retrieve metrics from.
  """
  ...
  * `:next_token` (`t:string`) A token to use for paginating results that are returned in the response. Set the value of
  ...
  ## Required positional parameters:
  * `:resource_arn` (`t:string`) The ARN of the <code>ScanName</code> object. You can retrieve this ARN by calling
  ...
  * `:resource_arn` (`t:string`) The ARN of the <code>ScanName</code> object. You can retrieve this ARN by calling
  ...
  ## Optional parameters:
  * `:tag_keys` (`t:list[com.amazonaws.codegurusecurity#TagKey]`) A list of keys for each tag you want to remove from a scan.
  """
