...
defmodule AWS.AuditManager do
  ...
  def get_change_logs(%Client{} = client, assessment_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [control_id: nil, control_set_id: nil, max_results: nil, next_token: nil
    # ])
    ...
    {control_set_id, options} = Keyword.pop(options, :control_set_id, nil)
    ...
    {control_id, options} = Keyword.pop(options, :control_id, nil)
  ...
  def get_evidence_file_upload_url(%Client{} = client, file_name, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [file_name: nil
    # ])

    headers = []
    query_params = []

    {file_name, options} = Keyword.pop(options, :file_name, nil)
  ...
  def list_assessment_control_insights_by_control_domain(
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [assessment_id: nil, control_domain_id: nil, max_results: nil, next_token: nil
    # ])
    ...
    {control_domain_id, options} = Keyword.pop(options, :control_domain_id, nil)
    ...
    {assessment_id, options} = Keyword.pop(options, :assessment_id, nil)
  ...
  def list_assessment_framework_share_requests(%Client{} = client, request_type, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [max_results: nil, next_token: nil, request_type: nil
    # ])

    headers = []
    query_params = []

    {request_type, options} = Keyword.pop(options, :request_type, nil)
  ...
  def list_assessment_frameworks(%Client{} = client, framework_type, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [framework_type: nil, max_results: nil, next_token: nil
    # ])
    ...
    {framework_type, options} = Keyword.pop(options, :framework_type, nil)
  ...
  def list_control_domain_insights_by_assessment(%Client{} = client, assessment_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [assessment_id: nil, max_results: nil, next_token: nil
    # ])
  ...
  def list_control_insights_by_control_domain(
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [control_domain_id: nil, max_results: nil, next_token: nil
    # ])
  ...
  def list_controls(%Client{} = client, control_type, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [control_type: nil, max_results: nil, next_token: nil
    # ])
    ...
    {control_type, options} = Keyword.pop(options, :control_type, nil)
  ...
  def list_keywords_for_data_source(%Client{} = client, source, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [max_results: nil, next_token: nil, source: nil
    # ])
