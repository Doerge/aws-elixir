...
defmodule AWS.M2 do
  ...
  * `:next_token` (`t:string`) A pagination token to control the number of
  ...
  def list_applications(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [environment_id: nil, max_results: nil, names: nil, next_token: nil
    # ])
  ...
  * `:prefix` (`t:`) If the batch job definition is a FileBatchJobDefinition, the
  ...
  def list_batch_job_definitions(%Client{} = client, application_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [max_results: nil, next_token: nil, prefix: nil
    # ])
  ...
  * `:status` (`t:string`) The status of the batch job executions.
  ...
  def list_batch_job_executions(%Client{} = client, application_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [execution_ids: nil, job_name: nil, max_results: nil, next_token: nil, started_after: nil, started_before: nil, status: nil
    # ])
    ...
    {started_before, options} = Keyword.pop(options, :started_before, nil)
    ...
    {started_after, options} = Keyword.pop(options, :started_after, nil)
    ...
    {execution_ids, options} = Keyword.pop(options, :execution_ids, nil)
  ...
  * `:prefix` (`t:string`) The prefix of the data set name, which you can use to
  ...
  def list_data_sets(%Client{} = client, application_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [max_results: nil, name_filter: nil, next_token: nil, prefix: nil
    # ])
  ...
  * `:next_token` (`t:string`) A pagination token returned from a previous call to
  ...
  def list_engine_versions(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [engine_type: nil, max_results: nil, next_token: nil
    # ])
  ...
  * `:next_token` (`t:string`) A pagination token to control the number of runtime
  ...
  def list_environments(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [engine_type: nil, max_results: nil, names: nil, next_token: nil
    # ])
