...
defmodule AWS.CloudFront do
  ...
  * `:stage` (`t:enum["DEVELOPMENT|LIVE"]`) The function&#39;s stage, either <code>DEVELOPMENT</code> or <code>LIVE</code>.
  ...
  def describe_function(%Client{} = client, name, options \\ []) do
    ...
    # options = Keyword.validate!(options, [stage: nil
    # ])

    headers = []
    query_params = []

    {stage, options} = Keyword.pop(options, :stage, nil)
  ...
  * `:type` (`t:enum["custom|managed"]`) A filter to return only the specified kinds of cache policies. Valid values
  ...
  def list_cache_policies(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [marker: nil, max_items: nil, type: nil
    # ])
  ...
  * `:max_items` (`t:integer`) The maximum number of conflicting aliases that you want in the response.
  ...
  def list_conflicting_aliases(%Client{} = client, alias, distribution_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [alias: nil, distribution_id: nil, marker: nil, max_items: nil
    # ])
    ...
    {distribution_id, options} = Keyword.pop(options, :distribution_id, nil)
  ...
  * `:stage` (`t:enum["DEVELOPMENT|LIVE"]`) An optional filter to return only the functions that are in the specified stage,
  ...
  def list_functions(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [marker: nil, max_items: nil, stage: nil
    # ])
  ...
  * `:status` (`t:string`) The status of the request for the key value stores list.
  ...
  def list_key_value_stores(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [marker: nil, max_items: nil, status: nil
    # ])
  ...
  * `:resource` (`t:string`) An ARN of a CloudFront resource.
  ...
  def list_tags_for_resource(%Client{} = client, resource, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [resource: nil
    # ])

    headers = []
    query_params = []

    {resource, options} = Keyword.pop(options, :resource, nil)
