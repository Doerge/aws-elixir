...
defmodule AWS.PaymentCryptographyData do
  ...
  * `:key_identifier` (`t:string`) The keyARN of the encryption key that Amazon
  ...
  Amazon Web Services Payment Cryptography supports `RSA`. To encrypt using
  DUKPT, a DUKPT key must already exist within your account with `KeyModesOfUse`
  set to `DeriveKey` or a new DUKPT can be generated by calling
  [CreateKey](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_CreateKey.html).
