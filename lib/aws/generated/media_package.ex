...
defmodule AWS.MediaPackage do
  ...
  * `:next_token` (`t:string`) 
  ...
  def list_harvest_jobs(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [include_channel_id: nil, include_status: nil, max_results: nil, next_token: nil
    # ])
    ...
    {include_channel_id, options} = Keyword.pop(options, :include_channel_id, nil)
  ...
  * `:next_token` (`t:string`) 
  ...
  def list_origin_endpoints(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [channel_id: nil, max_results: nil, next_token: nil
    # ])
    ...
    {channel_id, options} = Keyword.pop(options, :channel_id, nil)
