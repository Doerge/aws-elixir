...
defmodule AWS.KMS do
  ...
  *Key Management Service Developer Guide*.
  ...
  with the same
  name in different Regions. For detailed information about aliases, see [Using aliases](https://docs.aws.amazon.com/kms/latest/developerguide/kms-alias.html)
  in the
  *Key Management Service Developer Guide*.
  ...
  *. For examples of working with grants in several
  programming languages, see [Programming grants](https://docs.aws.amazon.com/kms/latest/developerguide/programming-grants.html).
  ...
  *.
  ...
  `ReplicateKey` operation. For instructions, see [Importing key material into multi-Region
  ...
  **Eventual consistency**: The KMS API follows an eventual consistency model.
  ...
  being automatically rotated. For details, see [How Automatic Key Rotation Works](https://docs.aws.amazon.com/kms/latest/developerguide/rotate-keys.html#rotate-keys-how-it-works)
  in the *Key Management Service Developer Guide*.
  ...
  **Eventual consistency**: The KMS API follows an eventual consistency model.
  ...
  [Key states of KMS keys](https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html) in
  the *
  *Key Management Service Developer Guide*
  *.
  ...
  **Eventual consistency**: The KMS API follows an eventual consistency model.
  ...
  key material for a KMS key. For more information about importing key material
  into KMS, see
  [Importing key material](https://docs.aws.amazon.com/kms/latest/developerguide/importing-keys.html)
  in the *Key Management Service Developer Guide*.
  ...
  a KMS key in a [custom key store](https://docs.aws.amazon.com/kms/latest/developerguide/custom-key-store-overview.html).
  You can also use `GetParametersForImport` to get a
  public key and import token to [reimport the original key material](https://docs.aws.amazon.com/kms/latest/developerguide/importing-keys.html#reimport-key-material)
  ...
  **Eventual consistency**: The KMS API follows an eventual consistency model.
  ...
  `ImportKeyMaterial` also sets the expiration model and expiration date of
  ...
  calling
  `ImportKeyMaterial` or using the [import features](kms/latest/developerguide/importing-keys-import-key-material.html#importing-keys-import-key-material-console)
  of the KMS console.
  ...
  asymmetric
  signing KMS key. You can also import key material into a [multi-Region key](kms/latest/developerguide/multi-region-keys-overview.html) of any
  supported type. However, you can't import key material into a KMS key in a
  [custom key store](kms/latest/developerguide/custom-key-store-overview.html). 
  ...
  If you are reimporting the same key material into an existing KMS key, you might
  need
  ...
  `PendingImport`. You cannot perform this operation on a KMS key in a [custom key
  store](kms/latest/developerguide/custom-key-store-overview.html), or on a KMS
  key in a different Amazon Web Services account. To get the `Origin` and
  `KeyState`
  ...
  **Eventual consistency**: The KMS API follows an eventual consistency model.
  ...
  your [KMS aliases quota](https://docs.aws.amazon.com/kms/latest/developerguide/limits.html#aliases-limit).
  ...
  *. For examples of adding a key policy in multiple programming languages,
  see [Setting a key policy](https://docs.aws.amazon.com/kms/latest/developerguide/programming-key-policies.html#put-policy)
  in the *Key Management Service Developer Guide*.
  ...
  **Eventual consistency**: The KMS API follows an eventual consistency model.
  ...
  libraries, such as
  the [Amazon Web Services Encryption SDK](https://docs.aws.amazon.com/encryption-sdk/latest/developer-guide/) or
  ...
  **Eventual consistency**: The KMS API follows an eventual consistency model.
  ...
  have the same [key spec](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-spec),
  ...
  key can differ,
  including its [key policy](https://docs.aws.amazon.com/kms/latest/developerguide/key-policies.html),
  ...
  *Key Management Service Developer Guide*.
  ...
  imported into the
  primary key. For details, see [Importing key material into multi-Region keys](https://docs.aws.amazon.com/kms/latest/developerguide/multi-region-keys-import.html)
  in the *Key Management Service Developer Guide*.
  ...
  **Required permissions**: Permission to retire a grant is
  determined primarily by the grant. For details, see [Retiring and revoking grants](https://docs.aws.amazon.com/kms/latest/developerguide/grant-manage.html#grant-delete)
  in
  the *Key Management Service Developer Guide*.
  ...
  **Eventual consistency**: The KMS API follows an eventual consistency model.
  ...
  begins. For details, see [Deleting multi-Region keys](https://docs.aws.amazon.com/kms/latest/developerguide/multi-region-keys-delete.html)
  in the
  *Key Management Service Developer Guide*.
  ...
  key material from the associated CloudHSM cluster. However, you might need to
  ...
  types of custom key stores, deleting a KMS key is destructive and irreversible.
  You cannot
  decrypt ciphertext encrypted under the KMS key by using only its associated
  external key or
  CloudHSM key. Also, you cannot recreate a KMS key in an external key store by
  creating a new KMS
  ...
  **Eventual consistency**: The KMS API follows an eventual consistency model.
  ...
  key in `us-east-1` becomes a replica key. For details, see [Updating the primary Region](https://docs.aws.amazon.com/kms/latest/developerguide/multi-region-keys-manage.html#multi-region-update)
  in the *Key Management Service Developer Guide*.
