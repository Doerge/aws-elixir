...
defmodule AWS.Bedrock do
  ...
  def get_guardrail(%Client{} = client, guardrail_identifier, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [guardrail_version: nil
    # ])

    headers = []
    query_params = []

    {guardrail_version, options} = Keyword.pop(options, :guardrail_version, nil)
  ...
  def list_custom_models(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [base_model_arn_equals: nil, creation_time_after: nil, creation_time_before: nil, foundation_model_arn_equals: nil, max_results: nil, name_contains: nil, next_token: nil, sort_by: nil, sort_order: nil
    # ])
    ...
    {foundation_model_arn_equals, options} =
      Keyword.pop(options, :foundation_model_arn_equals, nil)
    ...
    {base_model_arn_equals, options} = Keyword.pop(options, :base_model_arn_equals, nil)
  ...
  def list_evaluation_jobs(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [creation_time_after: nil, creation_time_before: nil, max_results: nil, name_contains: nil, next_token: nil, sort_by: nil, sort_order: nil, status_equals: nil
    # ])

    headers = []
    query_params = []

    {status_equals, options} = Keyword.pop(options, :status_equals, nil)
  ...
  def list_foundation_models(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [by_customization_type: nil, by_inference_type: nil, by_output_modality: nil, by_provider: nil
    # ])

    headers = []
    query_params = []

    {by_provider, options} = Keyword.pop(options, :by_provider, nil)
    ...
    {by_output_modality, options} = Keyword.pop(options, :by_output_modality, nil)
    ...
    {by_inference_type, options} = Keyword.pop(options, :by_inference_type, nil)
    ...
    {by_customization_type, options} = Keyword.pop(options, :by_customization_type, nil)
  ...
  def list_guardrails(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [guardrail_identifier: nil, max_results: nil, next_token: nil
    # ])
    ...
    {guardrail_identifier, options} = Keyword.pop(options, :guardrail_identifier, nil)
  ...
  def list_provisioned_model_throughputs(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [creation_time_after: nil, creation_time_before: nil, max_results: nil, model_arn_equals: nil, name_contains: nil, next_token: nil, sort_by: nil, sort_order: nil, status_equals: nil
    # ])
    ...
    {model_arn_equals, options} = Keyword.pop(options, :model_arn_equals, nil)
