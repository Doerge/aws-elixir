...
defmodule AWS.Mq do
  ...
  ## Required positional parameters:
   • :broker_id (t:string String.t/0) (BrokerId)
   • :username (t:string String.t/0) (Username)
  ...
  ## Optional parameters:
   • :engine_type (t:String.t/0) (engineType)
   • :host_instance_type (t:String.t/0) (hostInstanceType)
   • :max_results (t:String.t/0) (maxResults)
   • :next_token (t:String.t/0) (nextToken)
   • :storage_type (t:String.t/0) (storageType)
  """
  ...
  def describe_broker_instance_options(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [engine_type: nil, host_instance_type: nil, max_results: nil, next_token: nil, storage_type: nil
    # ])

    headers = []
    query_params = []

    {storage_type, options} = Keyword.pop(options, :storage_type, nil)
    ...
    {host_instance_type, options} = Keyword.pop(options, :host_instance_type, nil)
  ...
  ## Required positional parameters:
   • :configuration_id (t:string String.t/0) (ConfigurationId)
  ...
  ## Required positional parameters:
   • :configuration_id (t:string String.t/0) (ConfigurationId)
   • :configuration_revision (t:string String.t/0) (ConfigurationRevision)
