...
defmodule AWS.SecurityHub do
  ...
  *Security Hub User Guide*.
  ...
  def describe_hub(%Client{} = client, options \\ []) do
    ...
    # options = Keyword.validate!(options, [hub_arn: nil
    # ])

    headers = []
    query_params = []

    {hub_arn, options} = Keyword.pop(options, :hub_arn, nil)
  ...
  def describe_products(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [max_results: nil, next_token: nil, product_arn: nil
    # ])

    headers = []
    query_params = []

    {product_arn, options} = Keyword.pop(options, :product_arn, nil)
  ...
  def get_security_control_definition(%Client{} = client, security_control_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [security_control_id: nil
    # ])

    headers = []
    query_params = []

    {security_control_id, options} = Keyword.pop(options, :security_control_id, nil)
  ...
  def list_members(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [max_results: nil, next_token: nil, only_associated: nil
    # ])

    headers = []
    query_params = []

    {only_associated, options} = Keyword.pop(options, :only_associated, nil)
  ...
  def list_security_control_definitions(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [max_results: nil, next_token: nil, standards_arn: nil
    # ])

    headers = []
    query_params = []

    {standards_arn, options} = Keyword.pop(options, :standards_arn, nil)
  ...
  def list_standards_control_associations(%Client{} = client, security_control_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [max_results: nil, next_token: nil, security_control_id: nil
    # ])
