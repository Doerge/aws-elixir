...
defmodule AWS.EMRcontainers do
  ...
  *Amazon EMR containers* is the API name for Amazon EMR on EKS. The
  ...
  def list_job_runs(%Client{} = client, virtual_cluster_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [created_after: nil, created_before: nil, max_results: nil, name: nil, next_token: nil, states: nil
    # ])
  ...
  def list_job_templates(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [created_after: nil, created_before: nil, max_results: nil, next_token: nil
    # ])
  ...
  def list_managed_endpoints(%Client{} = client, virtual_cluster_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [created_after: nil, created_before: nil, max_results: nil, next_token: nil, states: nil, types: nil
    # ])
  ...
  def list_virtual_clusters(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [container_provider_id: nil, container_provider_type: nil, created_after: nil, created_before: nil, eks_access_entry_integrated: nil, max_results: nil, next_token: nil, states: nil
    # ])
    ...
    {eks_access_entry_integrated, options} =
      Keyword.pop(options, :eks_access_entry_integrated, nil)
    ...
    {container_provider_type, options} = Keyword.pop(options, :container_provider_type, nil)
    ...
    {container_provider_id, options} = Keyword.pop(options, :container_provider_id, nil)
