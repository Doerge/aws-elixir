...
defmodule AWS.Imagebuilder do
  ...
  *.
  ...
  def get_component(%Client{} = client, component_build_version_arn, options \\ []) do
    ...
    # options = Keyword.validate!(options, [component_build_version_arn: nil
    # ])

    headers = []
    query_params = []

    {component_build_version_arn, options} =
      Keyword.pop(options, :component_build_version_arn, nil)
  ...
  def get_component_policy(%Client{} = client, component_arn, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [component_arn: nil
    # ])

    headers = []
    query_params = []

    {component_arn, options} = Keyword.pop(options, :component_arn, nil)
  ...
  def get_container_recipe(%Client{} = client, container_recipe_arn, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [container_recipe_arn: nil
    # ])

    headers = []
    query_params = []

    {container_recipe_arn, options} = Keyword.pop(options, :container_recipe_arn, nil)
  ...
  def get_distribution_configuration(
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [distribution_configuration_arn: nil
    # ])

    headers = []
    query_params = []

    {distribution_configuration_arn, options} =
      Keyword.pop(options, :distribution_configuration_arn, nil)
  ...
  def get_image(%Client{} = client, image_build_version_arn, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [image_build_version_arn: nil
    # ])

    headers = []
    query_params = []

    {image_build_version_arn, options} = Keyword.pop(options, :image_build_version_arn, nil)
  ...
  def get_image_pipeline(%Client{} = client, image_pipeline_arn, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [image_pipeline_arn: nil
    # ])

    headers = []
    query_params = []

    {image_pipeline_arn, options} = Keyword.pop(options, :image_pipeline_arn, nil)
  ...
  def get_image_policy(%Client{} = client, image_arn, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [image_arn: nil
    # ])

    headers = []
    query_params = []

    {image_arn, options} = Keyword.pop(options, :image_arn, nil)
  ...
  def get_image_recipe(%Client{} = client, image_recipe_arn, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [image_recipe_arn: nil
    # ])

    headers = []
    query_params = []

    {image_recipe_arn, options} = Keyword.pop(options, :image_recipe_arn, nil)
  ...
  def get_infrastructure_configuration(
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [infrastructure_configuration_arn: nil
    # ])

    headers = []
    query_params = []

    {infrastructure_configuration_arn, options} =
      Keyword.pop(options, :infrastructure_configuration_arn, nil)
  ...
  def get_lifecycle_execution(%Client{} = client, lifecycle_execution_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [lifecycle_execution_id: nil
    # ])

    headers = []
    query_params = []

    {lifecycle_execution_id, options} = Keyword.pop(options, :lifecycle_execution_id, nil)
  ...
  def get_lifecycle_policy(%Client{} = client, lifecycle_policy_arn, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [lifecycle_policy_arn: nil
    # ])

    headers = []
    query_params = []

    {lifecycle_policy_arn, options} = Keyword.pop(options, :lifecycle_policy_arn, nil)
  ...
  def get_workflow(%Client{} = client, workflow_build_version_arn, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [workflow_build_version_arn: nil
    # ])

    headers = []
    query_params = []

    {workflow_build_version_arn, options} = Keyword.pop(options, :workflow_build_version_arn, nil)
  ...
  def get_workflow_execution(%Client{} = client, workflow_execution_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [workflow_execution_id: nil
    # ])

    headers = []
    query_params = []

    {workflow_execution_id, options} = Keyword.pop(options, :workflow_execution_id, nil)
  ...
  def get_workflow_step_execution(%Client{} = client, step_execution_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [step_execution_id: nil
    # ])

    headers = []
    query_params = []

    {step_execution_id, options} = Keyword.pop(options, :step_execution_id, nil)
