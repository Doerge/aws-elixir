...
defmodule AWS.AppSync do
  ...
  * `:domain_name` (`t:string` required) The domain name.
  ...
  ## Parameters:
  * `:source_api_identifier` (`t:string` required) The identifier of the AppSync
  Source API. This is generated by the AppSync service. In most cases, source
  APIs (especially in your account) only require the API ID value or ARN of
  the source API. However, source APIs from other accounts (cross-account use
  ...
  ## Parameters:
  * `:merged_api_identifier` (`t:string` required) The identifier of the AppSync
  Merged API. This is generated by the AppSync service. In most cases, Merged
  APIs (especially in your account) only require the API ID value or ARN of
  the merged API. However, Merged APIs in other accounts (cross-account use
  ...
  ## Parameters:
  * `:api_id` (`t:string` required) The GraphQL API ID.
  ## Keyword parameters:
  """
  ...
  ## Parameters:
  * `:api_id` (`t:string` required) The ID for your GraphQL API.
  ## Keyword parameters:
  """
  ...
  ## Parameters:
  * `:api_id` (`t:string` required) The API ID for the GraphQL API for the
  DataSource.
  ## Keyword parameters:
  """
  ...
  * `:api_id` (`t:string` required) The GraphQL API ID.
  ...
  ## Parameters:
  * `:api_id` (`t:string` required) The ID for the GraphQL API for which the
  resolver is being created.
  * `:type_name` (`t:string` required) The name of the Type.
  ## Keyword parameters:
  """
  ...
  ## Parameters:
  * `:api_id` (`t:string` required) The API ID.
  ## Keyword parameters:
  """
  ...
  * `:api_id` (`t:string` required) The API ID.
  ...
  ## Parameters:
  * `:api_id` (`t:string` required) The API ID.
  * `:id` (`t:string` required) The ID for the API key.
  ## Keyword parameters:
  """
  ...
  ## Parameters:
  * `:api_id` (`t:string` required) The API ID.
  * `:name` (`t:string` required) The name of the data source.
  ## Keyword parameters:
  """
  ...
  * `:domain_name` (`t:string` required) The domain name.
  ...
  ## Parameters:
  * `:api_id` (`t:string` required) The GraphQL API ID.
  * `:function_id` (`t:string` required) The Function ID.
  ## Keyword parameters:
  """
  ...
  * `:api_id` (`t:string` required) The API ID.
  ...
  ## Parameters:
  * `:api_id` (`t:string` required) The API ID.
  * `:field_name` (`t:string` required) The resolver field name.
  * `:type_name` (`t:string` required) The name of the resolver type.
  ## Keyword parameters:
  """
  ...
  ## Parameters:
  * `:api_id` (`t:string` required) The API ID.
  * `:type_name` (`t:string` required) The type name.
  ## Keyword parameters:
  """
  ...
  * `:domain_name` (`t:string` required) The domain name.
  ...
  ## Parameters:
  * `:association_id` (`t:string` required) The ID generated by the AppSync
  service for the source API association.
  * `:source_api_identifier` (`t:string` required) The identifier of the AppSync
  Source API. This is generated by the AppSync service. In most cases, source
  APIs (especially in your account) only require the API ID value or ARN of
  the source API. However, source APIs from other accounts (cross-account use
  ...
  * `:name` (`t:string` required) The name of the data source.
  ...
  ## Parameters:
  * `:introspection_id` (`t:string` required) The introspection ID. Each
  introspection contains a unique ID that can be used to reference the
  ...
  * `:function_id` (`t:string` required) The Function ID.
  ...
  ## Parameters:
  * `:api_id` (`t:string` required) The API ID for the GraphQL API.
  ## Keyword parameters:
  """
  ...
  ## Parameters:
  * `:api_id` (`t:string` required) The ID of the API from which the environmental
  variable list will be retrieved.
  ## Keyword parameters:
  """
  ...
  ## Parameters:
  * `:api_id` (`t:string` required) The API ID.
  * `:format` (`t:enum["JSON|SDL"]` required) The schema format: SDL or JSON.
  ## Keyword parameters:
  ...
  * `:api_id` (`t:string` required) The API ID.
  * `:field_name` (`t:string` required) The resolver field name.
  * `:type_name` (`t:string` required) The resolver type name.
  ## Keyword parameters:
  """
  ...
  * `:api_id` (`t:string` required) The API ID.
  * `:type_name` (`t:string` required) The type name.
  * `:format` (`t:enum["JSON|SDL"]` required) The type format: SDL or JSON.
  ## Keyword parameters:
  """
  ...
  * `:next_token` (`t:string`) An identifier that was returned from the previous
  ...
  ## Parameters:
  * `:resource_arn` (`t:string` required) The GraphqlApi Amazon Resource Name
  (ARN).
  ## Keyword parameters:
  """
  ...
  * `:merged_api_identifier` (`t:string` required) The identifier of the AppSync
  ...
  the merged API. However, Merged APIs in other accounts (cross-account use
  cases) strictly require the full resource ARN of the merged API.
  * `:format` (`t:enum["JSON|SDL"]` required) The format type.
  ## Keyword parameters:
  * `:max_results` (`t:integer`) The maximum number of results that you want the
  request to return.
  * `:next_token` (`t:string`) An identifier that was returned from the previous
  ...
  ## Parameters:
  * `:api_id` (`t:string` required) The ID of the API to which the environmental
  variable list will be written.
  ## Keyword parameters:
  """
  ...
  * `:resource_arn` (`t:string` required) The GraphqlApi Amazon Resource Name
  (ARN).
  * `:tag_keys` (`t:list[com.amazonaws.appsync#TagKey]` required) A list of TagKey
  objects.
  ## Keyword parameters:
  """
  ...
  * `:api_id` (`t:string` required) The GraphQL API ID.
  ...
  ## Parameters:
  * `:api_id` (`t:string` required) The ID for the GraphQL API.
  * `:id` (`t:string` required) The API key ID.
  ## Keyword parameters:
  """
  ...
  ## Parameters:
  * `:api_id` (`t:string` required) The API ID.
  * `:name` (`t:string` required) The new name for the data source.
  ## Keyword parameters:
  """
  ...
  * `:api_id` (`t:string` required) The API ID.
  ...
  ## Parameters:
  * `:api_id` (`t:string` required) The API ID.
  * `:field_name` (`t:string` required) The new field name.
  * `:type_name` (`t:string` required) The new type name.
  ## Keyword parameters:
  """
