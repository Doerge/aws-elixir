...
defmodule AWS.AppSync do
  ...
  ## Required positional parameters:
   • :source_api_identifier (t:string String.t/0) (sourceApiIdentifier)
  ...
  ## Required positional parameters:
   • :merged_api_identifier (t:string String.t/0) (mergedApiIdentifier)
  ...
  ## Required positional parameters:
   • :api_id (t:string String.t/0) (apiId)
   • :type_name (t:string String.t/0) (typeName)
  ...
  ## Required positional parameters:
   • :api_id (t:string String.t/0) (apiId)
   • :function_id (t:string String.t/0) (functionId)
  ...
  ## Required positional parameters:
   • :api_id (t:string String.t/0) (apiId)
   • :field_name (t:string String.t/0) (fieldName)
   • :type_name (t:string String.t/0) (typeName)
  ...
  ## Required positional parameters:
   • :introspection_id (t:string String.t/0) (introspectionId)

  ## Optional parameters:
   • :include_models_s_d_l (t:String.t/0) (includeModelsSDL)
  ...
  ## Optional parameters:
   ...
   • :include_directives (t:String.t/0) (includeDirectives)
  """
