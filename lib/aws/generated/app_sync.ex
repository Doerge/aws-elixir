...
defmodule AWS.AppSync do
  ...
  * `:domain_name` (`t:string`) The domain name.
  ...
  ## Required positional parameters:
  * `:source_api_identifier` (`t:string`) The identifier of the AppSync Source API. This is generated by the AppSync service. In most cases, source
  ...
  ## Required positional parameters:
  * `:merged_api_identifier` (`t:string`) The identifier of the AppSync Merged API. This is generated by the AppSync service. In most cases, Merged
  ...
  * `:api_id` (`t:string`) The ID for your GraphQL API.
  ...
  ## Required positional parameters:
  * `:api_id` (`t:string`) The API ID for the GraphQL API for the <code>DataSource</code>.
  ...
  * `:api_id` (`t:string`) The GraphQL API ID.
  ...
  ## Required positional parameters:
  * `:api_id` (`t:string`) The ID for the GraphQL API for which the resolver is being created.
  * `:type_name` (`t:string`) The name of the <code>Type</code>.
  ...
  * `:domain_name` (`t:string`) The domain name.
  ...
  ## Required positional parameters:
  * `:api_id` (`t:string`) The GraphQL API ID.
  * `:function_id` (`t:string`) The <code>Function</code> ID.
  ...
  * `:domain_name` (`t:string`) The domain name.
  ...
  ## Required positional parameters:
  * `:association_id` (`t:string`) The ID generated by the AppSync service for the source API association.
  * `:source_api_identifier` (`t:string`) The identifier of the AppSync Source API. This is generated by the AppSync service. In most cases, source
         APIs (especially in your account) only require the API ID value or ARN of the source API. However, source APIs
         from other accounts (cross-account use cases) strictly require the full resource ARN of the source API.
  ...
  * `:name` (`t:string`) The name of the data source.
  ...
  ## Required positional parameters:
  * `:introspection_id` (`t:string`) The introspection ID. Each introspection contains a unique ID that can be used to reference the
         instrospection record.

  ## Optional parameters:
  * `:include_models_s_d_l` (`t:boolean`) A boolean flag that determines whether SDL should be generated for introspected types or not. If set to
  ...
  * `:max_results` (`t:integer`) The maximum number of introspected types that will be returned in a single response.
  * `:next_token` (`t:string`) Determines the number of types to be returned in a single response before paginating. This value is
  ...
  def get_data_source_introspection(%Client{} = client, introspection_id, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [include_models_s_d_l: nil, max_results: nil, next_token: nil
    # ])
    ...
    {include_models_s_d_l, options} = Keyword.pop(options, :include_models_s_d_l, nil)
  ...
  * `:api_id` (`t:string`) The API ID for the GraphQL API.
  ...
  ## Required positional parameters:
  * `:api_id` (`t:string`) The ID of the API from which the environmental variable list will be retrieved.
  ...
  * `:include_directives` (`t:boolean`) A flag that specifies whether the schema introspection should contain directives.
  """
  ...
  def get_introspection_schema(%Client{} = client, api_id, format, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [format: nil, include_directives: nil
    # ])

    headers = []
    query_params = []

    {include_directives, options} = Keyword.pop(options, :include_directives, nil)
  ...
  * `:api_id` (`t:string`) The API ID.
  ...
  ## Optional parameters:
  * `:max_results` (`t:integer`) The maximum number of results that you want the request to return.
  * `:next_token` (`t:string`) An identifier that was returned from the previous call to this operation, which you can use to return the
  ...
  * `:next_token` (`t:string`) An identifier that was returned from the previous call to this operation, which you can use to return the
  ...
  ## Optional parameters:
  * `:api_type` (`t:enum["GRAPHQL|MERGED"]`) The value that indicates whether the GraphQL API is a standard API (<code>GRAPHQL</code>) or merged API
            (<code>MERGED</code>).
  * `:max_results` (`t:integer`) The maximum number of results that you want the request to return.
  * `:next_token` (`t:string`) An identifier that was returned from the previous call to this operation, which you can use to return the
         next set of items in the list.
  * `:owner` (`t:enum["CURRENT_ACCOUNT|OTHER_ACCOUNTS"]`) The account owner of the GraphQL API.
  """
  ...
  def list_graphql_apis(%Client{} = client, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [api_type: nil, max_results: nil, next_token: nil, owner: nil
    # ])
    ...
    {api_type, options} = Keyword.pop(options, :api_type, nil)
  ...
  * `:next_token` (`t:string`) An identifier that was returned from the previous call to this operation, which you can use to return the
  ...
  ## Required positional parameters:
  * `:resource_arn` (`t:string`) The <code>GraphqlApi</code> Amazon Resource Name (ARN).
  ...
  * `:next_token` (`t:string`) An identifier that was returned from the previous call to this operation, which you can use to return the
  ...
  def list_types(%Client{} = client, api_id, format, options \\ []) do
    ...
    # NOTE: We can't use validate!/2 here because the user might pass options to the client too...
    # options = Keyword.validate!(options, [format: nil, max_results: nil, next_token: nil
    # ])
  ...
  * `:next_token` (`t:string`) An identifier that was returned from the previous call to this operation, which you can use to return the
  ...
  ## Required positional parameters:
  * `:api_id` (`t:string`) The ID of the API to which the environmental variable list will be written.
  ...
  * `:resource_arn` (`t:string`) The <code>GraphqlApi</code> Amazon Resource Name (ARN).
  ...
  ## Optional parameters:
  * `:tag_keys` (`t:list[com.amazonaws.appsync#TagKey]`) A list of <code>TagKey</code> objects.
  """
